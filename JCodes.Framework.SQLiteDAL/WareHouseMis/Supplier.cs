...
namespace JCodes.Framework.SQLiteDAL
{
	...
	/// WareHouse 的摘要说明。
	/// </summary>
	public class Supplier : BaseDALSQLite<SupplierInfo>, ISupplier
	{
		#region 对象实例及构造函数
        ...
        public Supplier()
            : base(SQLitePortal.gc._wareHouseTablePre + "Supplier", "ID")
		{
            this.sortField = "ID";
        ...
        {
            string sql = string.Format("select ID, Code+'('+Name+')'  as Name from {0}Supplier order by ID", SQLitePortal.gc._wareHouseTablePre);
