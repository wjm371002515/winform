...
namespace JCodes.Framework.SQLiteDAL
{
    ...
    /// 通讯录分组
    /// </summary>
	public class AddressGroup : BaseDALSQLite<AddressGroupInfo>, IAddressGroup
	{
		#region 对象实例及构造函数
        ...
        public AddressGroup()
            : base(SQLitePortal.gc._contactTablePre + "AddressGroup", "ID")
		{
            this.sortField = "SEQ";
        ...
        public List<AddressGroupInfo> GetByContact(Int32 contactId)
        {
            ...
            ON t.ID = m.Group_ID Where m.Address_ID = '{2}' ", SQLitePortal.gc._contactTablePre, tableName, contactId);
