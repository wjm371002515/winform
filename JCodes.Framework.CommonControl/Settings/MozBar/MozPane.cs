...
{	
    ...
    [ToolboxBitmap(typeof(MozPane), "JCodes.Framework.CommonControl.Settings.MozPane.bmp")]
	...
	{	
		...
		protected override void WndProc(ref Message m)
		{
			...
			switch (m.Msg)
			{
                ...
                case Const.WM_NCCALCSIZE:
				{
					
					if (this.Style == MozPaneStyle.Vertical)
					{
						// hide horizontal scrollbar
                        ShowScrollBar(m.HWnd, Const.SB_HORZ, 0);
					}
					else
					{
						// hide vertical scrollbar
                        ShowScrollBar(m.HWnd, Const.SB_VERT, 0);
					}
		...
		{
            return (GetWindowLong(this.Handle, Const.GWL_STYLE) & Const.WS_VSCROLL) != 0;
		}

		internal bool IsHorizontalScrollBarVisible()
		{
            return (GetWindowLong(this.Handle, Const.GWL_STYLE) & Const.WS_HSCROLL) != 0;
		}
