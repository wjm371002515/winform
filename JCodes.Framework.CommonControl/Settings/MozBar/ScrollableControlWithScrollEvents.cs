		...
		protected override void WndProc(ref Message m)
		{
            ...
            if (m.Msg == Const.WM_HSCROLL) 
			{
				if ( HorizontalScroll != null ) 
				{
                    ...
                    si.fMask = Const.SIF_ALL;
                    bool ret = GetScrollInfo(this.Handle, Const.SB_HORZ, ref si);
            ...
            else if (m.Msg == Const.WM_VSCROLL)
			{
				...
				if ( VerticalScroll != null )
				{
					...
					si.cbSize = Marshal.SizeOf(si);
                    si.fMask = Const.SIF_ALL;
                    bool ret = GetScrollInfo(this.Handle, Const.SB_VERT, ref si);
					VerticalScroll( this, 
						new MozScrollEventArgs( 
						GetEventType( wParam & 0xffff), (int)(wParam >> 16),si ) );
