...
namespace JCodes.Framework.CommonControl.Other.Images
{
    ...
    public class WebPreview
    {
        ...
        private static void StaRun(object _wp)
        {
            ...
            {
                wp._ex = ex;
                LogHelper.WriteLog(LogLevel.LOG_LEVEL_CRIT, ex, typeof(WebPreview));
    ...
    internal class WebPreviewBase : IDisposable
    {
        ...
        public Bitmap GetWebPreview()
        {
            ...
            try
            {
                ...
                thumBitmap = (Bitmap)ImageHelper.ResizeImageToAFixedSize(thumBitmap, _thumbW, _thumbH, ScaleMode.W);
                return thumBitmap;
            }
            catch (Exception ex)
            {
