...
namespace JCodes.Framework.OracleDAL
{
    ...
    /// 通讯录分组
    /// </summary>
    public class AddressGroup : BaseDALOracle<AddressGroupInfo>, IAddressGroup
	{
		#region 对象实例及构造函数
		...
		public AddressGroup() : base(OraclePortal.gc._contactTablePre+"AddressGroup","ID")
		{
            this.sortField = "SEQ";
        ...
        public List<AddressGroupInfo> GetByContact(string contactId)
        {
            ...
            ON t.ID = m.Group_ID Where m.Address_ID = '{2}' ", OraclePortal.gc._contactTablePre, tableName, contactId);
