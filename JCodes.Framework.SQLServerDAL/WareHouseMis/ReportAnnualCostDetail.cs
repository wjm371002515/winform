...
namespace JCodes.Framework.SQLServerDAL
{
	...
	/// </summary>
    public class ReportAnnualCostDetail : BaseDALSQLServer<ReportAnnualCostDetailInfo>, IReportAnnualCostDetail
	{
		#region 对象实例及构造函数
        ...
        public ReportAnnualCostDetail()
            : base(SQLServerPortal.gc._wareHouseTablePre + "ReportAnnualCostDetail", "ID")
		{
		}
