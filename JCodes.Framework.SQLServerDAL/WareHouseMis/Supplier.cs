...
namespace JCodes.Framework.SQLServerDAL
{
	...
	/// WareHouse 的摘要说明。
	/// </summary>
    public class Supplier : BaseDALSQLServer<SupplierInfo>, ISupplier
	{
		#region 对象实例及构造函数
        ...
        public Supplier()
            : base(SQLServerPortal.gc._wareHouseTablePre + "Supplier", "ID")
        {
            this.sortField = "ID";
        ...
        {
            string sql = string.Format("select ID, Code+'('+Name+')'  as Name from {0}Supplier order by ID", SQLServerPortal.gc._wareHouseTablePre);
