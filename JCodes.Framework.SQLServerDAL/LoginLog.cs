...
namespace JCodes.Framework.Data.SQLServerDAL
{
    ...
    public class LoginLog : ILoginLog
    {
        ...
        public int GetTotalCount(string where)
        {
            ...
            object count = SqlHelper.ExecuteScalar(SqlHelper.connStr, CommandType.Text, strSql.ToString(), null);
        ...
        public DateTime? CheckLogin(string ip, out DateTime? lastLoginTime)
        {
            ...
            SqlHelper.ExecuteScalar(SqlHelper.connStr, CommandType.StoredProcedure, "sp_CheckLogin", paras);
        ...
        public bool WriteLoginLog(Model.LoginLog loginInfo)
        {
            ...
            object count = SqlHelper.ExecuteNonQuery(SqlHelper.connStr, CommandType.Text, sql, paras);
