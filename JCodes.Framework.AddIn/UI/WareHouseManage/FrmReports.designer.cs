...
namespace JCodes.Framework.AddIn.UI.WareHouseManage
{
    partial class FrmReports
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnAnnualReport = new VistaButton();
            this.btnAllMonthReport = new VistaButton();
            this.btnWareMonthlyReport = new VistaButton();
            this.btnDeptMonthlyReport = new VistaButton();
            this.btnPartMonthlyReport = new VistaButton();
