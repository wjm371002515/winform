...
namespace JCodes.Framework.AddIn.UI.BizControl
{
    ...
    public class VistaButton : System.Windows.Forms.UserControl
    {
        ...
        {
            if (this.ButtonStyle == WindowsStyle.Flat && this.mButtonState == State.None) { return; }
        ...
        private void VistaButton_MouseLeave(object sender, EventArgs e)
        {
            ...
            if (this.mButtonStyle == WindowsStyle.Flat) { mGlowAlpha = 0; }
            mFadeIn.Stop();
            mFadeOut.Start();
        }
        ...
        private void VistaButton_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (this.mButtonStyle != WindowsStyle.Flat) { mGlowAlpha = 255; }
                mFadeIn.Stop();
                mFadeOut.Stop();
                this.Invalidate();
            }
        ...
        {
            if (this.ButtonStyle == WindowsStyle.Flat) { mGlowAlpha = 0; }
