...
namespace JCodes.Framework.AddIn.Other
{
    ...
    public class ExRichTextBox : System.Windows.Forms.RichTextBox
    {
            ...
            : base()
        {
            ...
            rtfFontFamily.Add(Const.FF_UNKNOWN, RtfFontFamilyDef.Unknown);
        ...
        private string GetDocumentArea(string _text, Font _font)
        {
            ...
            _doc.Append(Const.RTF_DOCUMENT_PRE);
            ...
            _doc.Append(Const.RTF_DOCUMENT_POST);
        ...
        private string GetImagePrefix(Image _image)
        {
            ...
            int picw = (int)Math.Round((_image.Width / xDpi) * Const.HMM_PER_INCH);

            // Calculate the current height of the image in (0.01)mm
            int pich = (int)Math.Round((_image.Height / yDpi) * Const.HMM_PER_INCH);

            // Calculate the target width of the image in twips
            int picwgoal = (int)Math.Round((_image.Width / xDpi) * Const.TWIPS_PER_INCH);

            // Calculate the target height of the image in twips
            int pichgoal = (int)Math.Round((_image.Height / yDpi) * Const.TWIPS_PER_INCH);
        ...
        private string GetRtfImage(Image _image)
        {
            ...
            try
            {
                ...
                // size.
                uint _bufferSize = GdipEmfToWmfBits(_hEmf, 0, null, Const.MM_ANISOTROPIC,
                ...
                uint _convertedSize = GdipEmfToWmfBits(_hEmf, _bufferSize, _buffer, Const.MM_ANISOTROPIC,
                    EmfToWmfBitsFlags.EmfToWmfBitsFlagsDefault);
        ...
        private string GetFontTable(Font _font)
        {
            ...
            if (rtfFontFamily.Contains(_font.FontFamily.Name))
                ...
                _fontTable.Append(rtfFontFamily[Const.FF_UNKNOWN]);
