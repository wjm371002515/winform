...
namespace JCodes.Framework.AccessDAL
{
    ...
    /// 记录操作日志的数据表配置
    /// </summary>
    public class OperationLogSetting : BaseDALAccess<OperationLogSettingInfo>, IOperationLogSetting
    {
        #region 对象实例及构造函数
        ...
        public OperationLogSetting()
            : base(AccessPortal.gc._securityTablePre + "OperationLogSetting", "ID")
        {
