...
namespace JCodes.Framework.AccessDAL
{
    ...
    public class Role : BaseDALAccess<RoleInfo>, IRole
    {
        ...
        public List<RoleInfo> GetRolesByFunction(string functionID)
        {
            ...
            string sql = string.Format("SELECT * FROM T_ACL_Role, T_ACL_Role_Function Where T_ACL_Role.ID=T_ACL_Role_Function.Role_ID and Function_ID ='{0}' ", functionID);
        ...
        public List<RoleInfo> GetRolesByOU(int ouID)
        {
            ...
            string sql = "SELECT * FROM T_ACL_Role, T_ACL_OU_Role where T_ACL_Role.ID=Role_ID and OU_ID = " + ouID;
            return this.GetList(sql, null);
        }
        ...
        public List<RoleInfo> GetRolesByUser(int userID)
        {
            ...
            string sql = "SELECT * FROM T_ACL_Role, T_ACL_User_Role Where T_ACL_Role.ID=T_ACL_User_Role.Role_ID and User_ID = " + userID;
            return this.GetList(sql, null);
        }
