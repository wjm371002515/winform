...
namespace JCodes.Framework.AccessDAL
{
	...
	/// WareHouse 的摘要说明�?
	/// </summary>
	public class Supplier : BaseDALAccess<SupplierInfo>, ISupplier
    {
        #region  ����ʵ�������캯��
        ...
        public Supplier()
            : base(AccessPortal.gc._wareHouseTablePre + "Supplier", "ID")
        {
            this.sortField = "ID";
        ...
        {
            string sql = string.Format("select ID, Code+'('+Name+')'  as Name from {0}Supplier order by ID", AccessPortal.gc._wareHouseTablePre);
