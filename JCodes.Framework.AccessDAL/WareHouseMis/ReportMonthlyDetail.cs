...
namespace JCodes.Framework.AccessDAL
{
	...
	/// </summary>
	public class ReportMonthlyDetail : BaseDALAccess<ReportMonthlyDetailInfo>, IReportMonthlyDetail
	{
		#region 对象实例及构造函数
        ...
        public ReportMonthlyDetail()
            : base(AccessPortal.gc._wareHouseTablePre + "ReportMonthlyDetail", "ID")
		{
		}
