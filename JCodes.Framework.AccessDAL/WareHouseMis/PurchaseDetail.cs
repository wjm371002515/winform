...
namespace JCodes.Framework.AccessDAL
{
	...
	/// </summary>
	public class PurchaseDetail : BaseDALAccess<PurchaseDetailInfo>, IPurchaseDetail
	{
		#region 对象实例及构造函数
        ...
        public PurchaseDetail()
            : base(AccessPortal.gc._wareHouseTablePre + "PurchaseDetail", "ID")
		{
		}
        ...
        public DataTable GetPurchaseDetailReportByID(int PurchaseHead_ID)
        {
            ...
            Where h.ID={1} order by CreateDate ",AccessPortal.gc._wareHouseTablePre, PurchaseHead_ID);
