...
namespace JCodes.Framework.Common.Files
{
    ...
    public class FileAssociationsHelper
    {
        ...
        private static void Process(string[] args)
        {
            ...
            {
                LogHelper.WriteLog(LogLevel.LOG_LEVEL_CRIT, ex, typeof(FileAssociationsHelper));
            }
        }
            ...
            string appId, string openWith, string[] extensions)
        {
            ...
            catch (Win32Exception ex)
            {
                ...
                {
                    LogHelper.WriteLog(LogLevel.LOG_LEVEL_CRIT, "该操作已经被用户取消。", typeof(FileAssociationsHelper));
                }
            }
        }
