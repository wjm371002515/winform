    ...
    public class DGVPrinter
    {
        ...
        private void measureprintarea(Graphics g)
        {
            ...
            for (i = 0; i < colstoprint.Count; i++)
            {
                ...
                SizeF size = g.MeasureString(col.HeaderText, headercolstyle.Font, new SizeF(usewidth, Const.maxPages),
            ...
            for (i = 0; i < rowstoprint.Count; i++)
            {
                ...
                for (j = 0; j < colstoprint.Count; j++)
                {
                    ...
                    if ((0 <= colwidthsoverride[j]) || (size.Width > printWidth))
                    {
                        ...
                        int chars, lines;
                        size = g.MeasureString(datastr, colstyle.Font, new SizeF(colwidths[j] - colstyle.Padding.Left - colstyle.Padding.Right, Const.maxPages),
