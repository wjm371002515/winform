...
namespace JCodes.Framework.Common
{
    ...
    public class Camera
    {
        ...
        public void StartWebCam()
        {
            ...
            this.lwndC = AviCapture.capCreateCaptureWindowA(lpszName, Const.WS_VISIBLE + Const.WS_CHILD, 0, 0, mWidth, mHeight, mControlPtr, 0);
        ...
        public void GrabImage(string path)
        {
            ...
            AviCapture.SendMessage(lwndC, Const.WM_CAP_FILE_SAVEDIB, 0, hBmp.ToInt32());
        }
        ...
        {
            return AviCapture.SendMessage(lwndC, Const.WM_CAP_EDIT_COPY, 0, 0);
        }
        ...
        public void SetCaptureSource()
        {
            ...
            AviCapture.SendMessage(lwndC, Const.WM_CAP_DRIVER_GET_CAPS, AviCapture.SizeOf(caps), ref  caps);
            if (caps.fHasDlgVideoSource)
            {
                AviCapture.SendMessage(lwndC, Const.WM_CAP_DLG_VIDEOSOURCE, 0, 0);
            }
        }
        ...
        public void SetCaptureFormat() 
        {
            ...
            if (caps.fHasDlgVideoSource)
            {
                AviCapture.SendMessage(lwndC, Const.WM_CAP_DLG_VIDEOFORMAT, 0, 0);
            }
        }
        ...
        {
            return AviCapture.SendMessage(lwnd, Const.WM_CAP_DRIVER_CONNECT, i, 0);
        }

        private bool capDriverDisconnect(IntPtr lwnd)
        {
            return AviCapture.SendMessage(lwnd, Const.WM_CAP_DRIVER_DISCONNECT, 0, 0);
        }

        private bool capPreview(IntPtr lwnd, bool f)
        {
            return AviCapture.SendMessage(lwnd, Const.WM_CAP_SET_PREVIEW, f, 0);
        }

        private bool capPreviewRate(IntPtr lwnd, short wMS)
        {
            return AviCapture.SendMessage(lwnd, Const.WM_CAP_SET_PREVIEWRATE, wMS, 0);
        }

        private bool capSetCallbackOnFrame(IntPtr lwnd, AviCapture.FrameEventHandler lpProc)
        {
            return AviCapture.SendMessage(lwnd, Const.WM_CAP_SET_CALLBACK_FRAME, 0, lpProc);
        }

        private bool capSetVideoFormat(IntPtr hCapWnd, ref AviCapture.BITMAPINFO BmpFormat, int CapFormatSize)
        {
            return AviCapture.SendMessage(hCapWnd, Const.WM_CAP_SET_VIDEOFORMAT, CapFormatSize, ref BmpFormat);
        }
        ...
        {
            return AviCapture.SendMessage(lwnd, Const.WM_CAP_SET_OVERLAY, f, 0);
        } 
        #endregion
