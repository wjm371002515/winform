...
namespace JCodes.Framework.Common
{
    public class Const
    {
        ...
        #region 连接access数据库
        public const string accessPrefix = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source={0};User ID=Admin;Jet OLEDB:Database Password=;";
        #endregion 
        ...
        #region Excel格式内容
        public const string startExcelXML = "<xml version>\r\n<Workbook " +
                  ...
                  "</Styles>\r\n ";
        public const string endExcelXML = "</Workbook>";
        #endregion

        public const string ConfigFilter = "配置文件(*.cfg)|*.cfg|All File(*.*)|*.*";

        #region 提示信息常量
        public const string ExceptionEmptyString = "参数 '{0}'的值不能为空字符串。";
        public const string ExceptionInvalidNullNameArgument = "参数'{0}'的名称不能为空引用或空字符串。";
        public const string ExceptionByteArrayValueMustBeGreaterThanZeroBytes = "数值必须大于0字节.";
        public const string ExceptionExpectedType = "无效的类型，期待的类型必须为'{0}'。";
        public const string ExceptionEnumerationNotDefined = "{0}不是{1}的一个有效值";
        #endregion
        ...
        public const int MaxAttachmentNum = 10;
        ...
        /// </summary>
        public const string CCalendarDateFile = "JCodes.Framework.Common.Others.CCalendarData.xml";
...
|〖|〗|【|】|（|）|［|］|『|』|\.";
        ...
        public const int maxPages = 2147483647;
        ...
        public const int numOfChars = 256;
        ...
        public const int animationLength = 300;
        ...
        public const string SaveConfigName = "POSPrinterName";
        ...
        public const string strHash = "Commons";

        /// <summary>
        /// 公钥
        /// </summary>
        public const string publicKey = "<RSAKeyValue><Modulus>2R0c+bMw7wc6l4AYZBknyW3teZja2e8H4tE5JY1we/Ty9ukv2UAeGvKPFn5YMMHi0UJBm7nrfU+X64OTDdrAjVBdOcrh4/ZGmQ9gwXPzIiy0RHi7YG+bWH7zUEuql02EgJuqfnxcSW9JUtzDJwUqZqcZvsE/fu8DQ6kQJBQ/e4E=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";

        /// <summary>
        /// 秘钥
        /// </summary>
        public const string privateKey = "<RSAKeyValue><Modulus>2R0c+bMw7wc6l4AYZBknyW3teZja2e8H4tE5JY1we/Ty9ukv2UAeGvKPFn5YMMHi0UJBm7nrfU+X64OTDdrAjVBdOcrh4/ZGmQ9gwXPzIiy0RHi7YG+bWH7zUEuql02EgJuqfnxcSW9JUtzDJwUqZqcZvsE/fu8DQ6kQJBQ/e4E=</Modulus><Exponent>AQAB</Exponent><P>6DJi2FRr4s916iB1WcTjhqUs1mPZVPT0nX/uSWvot42ivQycnUs3Iu1aQIocTjm3k4zDpz5EsAz9lFQL1HfZ3w==</P><Q>717liR5iAsMjHHt0T44EIbENfzqPticpHAYRRI55WqBlQGO1ObAX90JH5n7AiQexpilJvLHApH2D7x74PaoWnw==</Q><DP>KRdxorMd/J+WUH66Bc7wLQ3iJ3a4KW7IM29GbjvojUNFf4tR1AxRj57NkAphA/722+fXYCuG4FkML0nIZitnpQ==</DP><DQ>W6piiizpaZditcCNHP4MlP5hZcx+Rkoe0w17xV4uGMd9nrfQKaRGuThXomv9vTwGCtSa2TjUxekPAh5BABRHjw==</DQ><InverseQ>OUdNRsOUSe/wSSCo/oOoJkC2i0qAB0fJ9+0B57+UKVHSJ/WUMKaGTwNKftyGeITTUDICbUZrOmLgphOnWkx6SA==</InverseQ><D>GRwUW06dlK9t19KxP3ZnUxT7F4qVmQnbjCBtbwnmHffs16CNb59KPAycftn64hyyWkhC5TtB4HrBk7PiYIJRrW+5ioCKn+8rmitpdJmTIWForNx1v6joTAhERcfCZs2niQinqr0vs5P/BiBmXKjlntW1Z3BmviYe3DlUbDzCZO8=</D></RSAKeyValue>";
