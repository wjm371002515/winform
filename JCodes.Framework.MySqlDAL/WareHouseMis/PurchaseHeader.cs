...
namespace JCodes.Framework.MySqlDAL
{
	...
	/// </summary>
	public class PurchaseHeader : BaseDALMySql<PurchaseHeaderInfo>, IPurchaseHeader
	{
		#region 对象实例及构造函数
        ...
        public PurchaseHeader()
            : base(MySqlPortal.gc._wareHouseTablePre + "PurchaseHeader", "ID")
		{
		}
        ...
        public int GetPurchaseQuantity(string condition, bool isIn)
        {
            ...
            INNER JOIN {0}PurchaseHeader AS h ON d.PurchaseHead_ID = h.ID Where {1} AND {2}", MySqlPortal.gc._wareHouseTablePre, subWhere, condition);
