            ...
            foreach (DataTypeInfo dataTypeInfo in lstDataTypeInfo)
            {
                ...
                if (tmpName.Contains(dataTypeInfo.Name))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("类型名" + dataTypeInfo.Name, "存在键值相同的类型名"));
                    }
                }
                // 类型名判断大驼峰
                if (dataTypeInfo.Name.Length >= 1)
                {
                    if (!string.Equals(dataTypeInfo.Name[0].ToString(), dataTypeInfo.Name[0].ToString().ToUpper(), StringComparison.CurrentCulture))
                    {
                        ...
                        else
                        {
                            ...
                            _warnCount++;
                            _warnlst.Add(new CListItem("类型名" + dataTypeInfo.Name, "类型名以大驼峰命名规范"));
                        }
                    }
                }
                ...
                if (string.IsNullOrEmpty(dataTypeInfo.Name))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("类型名" + dataTypeInfo.Name, "类型名不能为空"));
                    }
                }
                // 判断名称是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.ChineseName))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("名称" + dataTypeInfo.Name, "名称不能为空"));
                    }
                }
                // 判断Oracle是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.Oracle))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("Oracle" + dataTypeInfo.Name, "Oracle不能为空"));
                    }
                }
                // 判断Mysql是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.Mysql))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("Mysql" + dataTypeInfo.Name, "Mysql不能为空"));
                    }
                }
                // 判断DB2是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.DB2))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("DB2" + dataTypeInfo.Name, "DB2不能为空"));
                    }
                }
                // 判断SqlServer是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.SqlServer))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("SqlServer" + dataTypeInfo.Name, "SqlServer不能为空"));
                    }
                }
                // 判断Sqlite是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.Sqlite))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("Sqlite" + dataTypeInfo.Name, "Sqlite不能为空"));
                    }
                }
                // 判断Access是否为空
                if (string.IsNullOrEmpty(dataTypeInfo.Access))
                {
                    ...
                    else
                    {
                        ...
                        _errCount++;
                        _errlst.Add(new CListItem("Access" + dataTypeInfo.Name, "Access不能为空"));
                    }
                }
            }
        }
